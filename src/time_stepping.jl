...
function rk3step_SH!(F, U0, U, t, dt, fractions, p, psolver, setup, Bub, Precomp_SH)
    ...
    for i in 1:nstage
        ...
        map_surface_tension!(F.u, setup, tension, Dynamic_SH.r, Precomp_SH.ϕ, Precomp_SH.θ)
        applygravity!(F.u, setup)
        u_cub = map_velocity(U.u, setup, Dynamic_SH.r, Precomp_SH.ϕ, Precomp_SH.θ)
